...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/AtroMusic/Extra-Plugin",
)
...
LOG_GROUP_ID = getenv("LOG_GROUP_ID", "-1002167439274")


# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "6543211255").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/AtroMusic/YukkiMusic",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/atrinmusic_tm"
